		...
		if(isset($_POST['enregistrer'])) 
            ...
            //On nettoie les valeurs
			 ...
			 if(empty($description) || is_numeric($description[0])){
				...
				$query = $con->prepare('INSERT INTO declaration_perdu(id_utilisateur,code_declaration,descriptions,contact,date_declaration) VALUES (?,?,?,?,?)');
